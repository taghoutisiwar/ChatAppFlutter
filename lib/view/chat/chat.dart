...
import 'package:chat_app/view/chat/customAppBar.dart';
...
import 'package:chat_app/themeData.dart';
    ...
    Future uploadFile() async {
      if (_image != null) {
        ...
        await _firestore.collection(widget.chat.collectionName).add({
          'text': urlDownload,
          'sender': authController.getUser().uid,
          'type': "image",
...
class _MessageBubbleState extends State<MessageBubble> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
        ...
        child: widget.sender == AuthController.instance.getUser().uid
            ? Row(
                ...
                children: [
                  Column(
                    ...
                    children: <Widget>[
                      Text(
                        AuthController.instance.userData.value.firstName,
            ...
            : StreamBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  try {
                    senderData.firstName = snapshot.data['firstName'];
                    senderData.uid = widget.sender;
                    senderData.lastName = snapshot.data['lastName'];
                    senderData.pfp = pfp;
                  } catch (e) {
                    print(e.toString());
                  }
...
Future<UserModel> getSenderData(String uid) async {
